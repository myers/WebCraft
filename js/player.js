...
Player.prototype.update = function()
{
	...
	if ( this.lastUpdate != null )
	{
		...
		// Jumping
		if ( this.keys[localStorage["keys.jump"]] && !this.falling )
			velocity.z = 8;
